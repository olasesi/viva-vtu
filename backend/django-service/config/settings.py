...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Viva VTU Analytics API',
    'DESCRIPTION': 'Analytics and reporting microservice for Viva VTU platform',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'COMPONENT_SPLIT_REQUEST': True,
    'TAGS': [
        {'name': 'Analytics', 'description': 'Dashboard and analytics endpoints'},
        {'name': 'Transactions', 'description': 'Transaction event management'},
...
# Billing Service (for sync tasks)
BILLING_SERVICE_URL = os.getenv('BILLING_SERVICE_URL', 'http://localhost:8000')
